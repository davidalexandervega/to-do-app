        ...
        <>
            <div ref={editRef} className='editListContainer'>
                ...
                <form className='listForm'>
                    <input type='text' className='formControl' id='renListTitle'
                    name='renameTitle' value={renameTitle} onChange={onChange} size='10'></input>
                ...
                <div className="deleteListHeader">
                    to <b>delete,</b> type <i><b>{list.title}</b></i> into the field & click to <b>confirm deletion</b>:
                </div>
                <form className='listForm'>
                    <input type='text' className='formControl' id='delListTitle'
                    name='deleteTitle' value={deleteTitle} onChange={onChange} size='10'></input>
